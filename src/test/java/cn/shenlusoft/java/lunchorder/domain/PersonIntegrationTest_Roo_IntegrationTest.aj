...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = cn.shenlusoft.java.lunchorder.domain.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        cn.shenlusoft.java.lunchorder.domain.Person obj = dod.getRandomPerson();
        ...
        obj = cn.shenlusoft.java.lunchorder.domain.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<cn.shenlusoft.java.lunchorder.domain.Person> result = cn.shenlusoft.java.lunchorder.domain.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<cn.shenlusoft.java.lunchorder.domain.Person> result = cn.shenlusoft.java.lunchorder.domain.Person.findPersonEntries(0, (int) count);
    ...
    public void PersonIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyPerson(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        cn.shenlusoft.java.lunchorder.domain.Person merged =  obj.merge();
        obj.flush();
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        cn.shenlusoft.java.lunchorder.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", cn.shenlusoft.java.lunchorder.domain.Person.findPerson(id));
    }
